...
va_tracts<-tracts("VA",cb=T)

places_shp<-st_read("geo_export_bc3f9e42-d5c1-44b7-8241-f1f829181d9d.shp")
...
st_write(pburg_merged, "pburg_merged.shp")

test2<-readRDS("pburg_merged.RDS")

test<-st_read("pburg_merged.shp")
